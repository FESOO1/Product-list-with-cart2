...
for (let i = 0; i < 9; i++) {
    ...
    <div class="dessert-image">
        <img src="./assets/images/image-baklava-desktop.jpg" alt="" class="dessert-image-itself">
    </div>
    ...
    <span class="dessert-category">Waffle</span>
    <h4 class="dessert-name">Waffle with Berries</h4>
    <h4 class="dessert-price">$6.50</h4>
    </div>
    `;
